        ...
        <div class="relative py-8">
            ...
            <div class="text-center">
                <div class="flex justify-center mb-4">
                    <img src="<?php echo e(url(config('settings.logo'))); ?>"
                        class="h-20 w-auto"
                        alt="<?php echo e(config('settings.web_name')); ?>">
                </div>

                <h1 class="text-3xl sm:text-4xl font-bold text-slate-900">
                    <?php echo e(config('settings.web_name', 'Hệ thống Quản lý Giáo lý')); ?>
                            ...
                            <div class="flex-1 space-y-2">
                                ...
                                <div class="space-y-1.5 text-sm">
                                    <p class="flex justify-between">
                                        ...
                                        <span class="text-slate-900"><?php echo e($result['student']->name); ?></span>
                                    </p>
                                    <p class="flex justify-between">
                                        <span class="font-semibold text-slate-700">Mã HS:</span>
                                        <span class="text-slate-900 font-mono"><?php echo e($result['student']->code); ?></span>
                                    </p>
                                    <p class="flex justify-between">
                                        <span class="font-semibold text-slate-700">Năm học:</span>
                                        <span class="text-slate-900">
                                            <?php echo e($result['schoolYear']?->name ?? 'Chưa có năm học'); ?>
...
</div><?php /**PATH D:\Document\WORKING\lavarel_qlgx\resources\views/livewire/landing.blade.php ENDPATH**/ ?>