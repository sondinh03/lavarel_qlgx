...
<tr>
    <td colspan="<?php echo e($colspan); ?>" class="px-6 py-16 text-center">
        <div class="flex flex-col items-center justify-center">
            ...
            <p class="text-slate-700 font-semibold text-lg mb-2"><?php echo e($title); ?></p>

            
            <?php if($description): ?>
                <p class="text-slate-500 text-sm mb-4 max-w-md"><?php echo e($description); ?></p>
            <?php endif; ?>
...
</tr><?php /**PATH D:\Document\WORKING\lavarel_qlgx\resources\views/components/empty-state.blade.php ENDPATH**/ ?>