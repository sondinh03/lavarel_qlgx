...
<?php endif; ?>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
            ...
            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.page-header','data' => ['title' => 'Quản lý lớp học','description' => ''.e($selectedNamHoc ? 'Quản lý ' . ($lops ? $lops->total() : 0) . ' lớp học trong năm học ' . ($namHocs[$selectedNamHoc] ?? '') : 'Chọn năm học để xem danh sách lớp').'','icon' => 'class','gradient' => 'purple','count' => $selectedNamHoc && $lops ? $lops->total() : null,'countLabel' => 'Tổng số lớp']]); ?>
<?php $component->withName('page-header'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['title' => 'Quản lý lớp học','description' => ''.e($selectedNamHoc ? 'Quản lý ' . ($lops ? $lops->total() : 0) . ' lớp học trong năm học ' . ($namHocs[$selectedNamHoc] ?? '') : 'Chọn năm học để xem danh sách lớp').'','icon' => 'class','gradient' => 'purple','count' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($selectedNamHoc && $lops ? $lops->total() : null),'count-label' => 'Tổng số lớp']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['wire-target' => 'selectedNamHoc,selectedKhoi,resetFilters','mode' => 'centered']); ?>Đang tải danh sách lớp... <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
            ...
            <div class="overflow-x-auto">
                <table class="w-full border-separate border-spacing-0" role="table" aria-label="Danh sách lớp học" aria-describedby="lop-list-caption">
                    <caption id="lop-list-caption" class="sr-only">
                        Danh sách <?php echo e($lops ? $lops->total() : 0); ?> lớp học
                        <?php if($selectedNamHoc): ?> trong năm học <?php echo e($namHocs[$selectedNamHoc] ?? ''); ?> <?php endif; ?>
                        <?php if($selectedKhoi): ?> khối <?php echo e($khois[$selectedKhoi] ?? ''); ?> <?php endif; ?>
                    </caption>
