...
<head>
    ...
    <title><?php echo e(config('settings.web_name', 'Phần mềm quản lý giáo xứ và giáo lý')); ?></title>
                ...
                <div class="row">
                    <div class="col-12 col-md-3 mb-3 mb-md-0">
                        <div class="flex justify-content-center">
                            <a class="text-3xl font-bold leading-none text-decoration-none" href="<?php echo e(url('/')); ?>">
                    ...
                    <div class="col-12 col-md-9 d-flex justify-content-between align-items-center">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            <ul class="navbar-nav ms-auto">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo e(route('login')); ?>"><?php echo e(__('frontend.Login')); ?></a>
                                </li>
                                <?php endif; ?>

                                <?php if(Route::has('register')): ?>
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo e(route('register')); ?>"><?php echo e(__('frontend.Register')); ?></a>
                                </li>
                                <?php endif; ?>
                                <?php else: ?>
...
<?php /**PATH D:\Document\WORKING\lavarel_qlgx\resources\views/layouts/app.blade.php ENDPATH**/ ?>