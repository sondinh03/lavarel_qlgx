        ...
        <div class="bg-red-50 border-2 border-red-200 rounded-2xl overflow-hidden">
            <div class="p-4 bg-red-100 border-b border-red-200">
                <h3 class="font-semibold text-red-900 flex items-center gap-2">
                    ...
                    Phát hiện <?php echo e(count($errors)); ?> lỗi trong dữ liệu
                </h3>
            </div>
            <div class="p-4">
                <ul class="space-y-2">
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-sm text-slate-600 mt-1">
                            Tìm thấy <span class="font-semibold text-slate-900"><?php echo e(count($rows)); ?></span> bản ghi
                            <?php if($readyToImport): ?>
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div class="text-center">
                            <div class="text-2xl font-bold text-green-600"><?php echo e($validCount); ?></div>
                            <div class="text-xs text-slate-600">Hợp lệ</div>
                        </div>

                        <?php if($duplicateCount > 0): ?>
                        <div class="text-center">
                            <div class="text-2xl font-bold text-red-600"><?php echo e($duplicateCount); ?></div>
                ...
                <table class="w-full border-separate border-spacing-0">
                    ...
                    <tbody class="divide-y divide-slate-100">
                        ...
                        <tr class="hover:bg-slate-50 transition-colors
                                   <?php echo e($row['duplicate'] ? 'bg-red-50' : ''); ?>">
                            ...
                            <td class="px-4 py-3 text-center border-b border-slate-100">
                                <?php if(strtolower($row['tao_tai_khoan']) === 'có' || strtolower($row['tao_tai_khoan']) === 'yes'): ?>
...
<?php $__env->stopPush(); ?><?php /**PATH D:\Document\WORKING\lavarel_qlgx\resources\views/livewire/teacher/teacher-import-preview.blade.php ENDPATH**/ ?>