...
<div class="bg-gradient-to-r <?php echo e($selectedGradient); ?> p-6 rounded-t-2xl">
    <div class="flex items-center justify-between text-white">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-xl font-bold"><?php echo e($title); ?></h1>
                <?php if($description): ?>
                    <p class="text-white/90 text-sm mt-0.5"><?php echo e($description); ?></p>
                <?php endif; ?>
            </div>
        </div>
        ...
        <?php if($count !== null): ?>
            <div class="text-right">
                <p class="text-white/90 text-sm font-medium"><?php echo e($countLabel); ?></p>
                <p class="text-3xl font-bold"><?php echo e($count); ?></p>
            </div>
        <?php endif; ?>
