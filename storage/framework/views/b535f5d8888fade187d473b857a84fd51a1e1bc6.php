                ...
                <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
                    ...
                    <div class="p-6 border-b border-slate-200 bg-gradient-to-br from-primary-50 to-white">
                        <div class="flex items-start justify-between">
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    <h1 class="text-2xl font-bold text-slate-900"><?php echo e($lopData['name'] ?? 'N/A'); ?></h1>
                                    <?php if(!empty($lopData['symbol'])): ?>
                                    <p class="text-sm text-slate-600 mt-1">
                                        Mã lớp: <span class="font-mono font-semibold text-slate-900"><?php echo e($lopData['symbol']); ?></span>
                                    </p>
                                    <?php endif; ?>
                                </div>
                            </div>
                            ...
                            <div class="text-right">
                                <div class="text-3xl font-bold text-primary-600"><?php echo e($statistics['total'] ?? 0); ?></div>
                    ...
                    <div class="grid grid-cols-4 gap-4 p-6 bg-slate-50 border-b border-slate-200">
                        ...
                        <div class="flex flex-col items-center text-center p-4 bg-white rounded-xl border border-slate-200">
                            ...
                            <span class="text-lg font-bold text-slate-900">
                                <?php echo e($statistics['female'] ?? 0); ?>
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-slate-700 text-sm leading-relaxed bg-slate-50 p-3 rounded-lg"><?php echo e($lopData['note']); ?></p>
                    </div>
                    <?php endif; ?>
                </div>

                
                <?php if(!empty($lopData['start_date_one']) || !empty($lopData['start_date_two'])): ?>
                <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
                    <div class="p-6">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <?php if(!empty($lopData['start_date_one']) && !empty($lopData['end_date_one'])): ?>
                            <div class="flex items-center gap-4 p-4 bg-gradient-to-br from-primary-50 to-primary-50 rounded-xl border border-primary-200">
                                ...
                                <div class="min-w-0">
                                    ...
                                    <p class="text-xs text-slate-600 font-medium mt-0.5">
                                        <?php echo e($lopData['start_date_one']); ?> - <?php echo e($lopData['end_date_one']); ?>
                            ...
                            <div class="flex items-center gap-4 p-4 bg-gradient-to-br from-primary-50 to-primary-100 rounded-xl border border-primary-200">
                                ...
                                <div class="min-w-0">
                                    ...
                                    <p class="text-xs text-slate-600 font-medium mt-0.5">
                                        <?php echo e($lopData['start_date_two']); ?> - <?php echo e($lopData['end_date_two']); ?>
            ...
            <div class="space-y-5">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
                    ...
                    <div class="p-4 space-y-2">
                        ...
                        <a href="<?php echo e(route('lop.show', $lopData['id'] ?? 0)); ?>"
                        ...
                        <a href="<?php echo e(route('attendance', $lopData['id'] ?? 0)); ?>"
                        ...
                        <a href="<?php echo e(route('home', $lopData['id'] ?? 0)); ?>"
                            class="flex items-center gap-3 w-full px-4 py-2.5 bg-slate-50 hover:bg-slate-100 text-slate-900 rounded-xl transition-all font-medium">
                            <svg class="w-5 h-5 text-slate-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="<?php echo e(route('lop.edit', $lopData['id'] ?? 0)); ?>"
                            class="flex items-center gap-3 w-full px-4 py-2.5 bg-slate-50 hover:bg-slate-100 text-slate-900 rounded-xl transition-all font-medium">
                            <svg class="w-5 h-5 text-slate-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
                    <div class="p-4 border-b border-slate-200 bg-slate-50">
                        <h3 class="text-sm font-bold text-slate-900 flex items-center gap-2">
                            ...
                            Giáo lý viên
                            <?php if(!empty($teachers) && count($teachers) > 0): ?>
                            <span class="text-xs font-normal text-slate-600">(<?php echo e(count($teachers)); ?>)</span>
                            <?php endif; ?>
                        </h3>
                    </div>
                    <div class="p-4">
                        ...
                        <div class="space-y-2">
                            ...
                            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.teacher.badge','data' => ['name' => $teacher['name'],'isChuNhiem' => $teacher['is_chu_nhiem'] ?? false,'size' => '8']]); ?>
<?php $component->withName('teacher.badge'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['name' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($teacher['name']),'isChuNhiem' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($teacher['is_chu_nhiem'] ?? false),'size' => '8']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
