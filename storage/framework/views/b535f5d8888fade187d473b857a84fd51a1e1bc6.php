                    ...
                    <div class="p-6 border-b border-slate-200 bg-gradient-to-br from-primary-50 to-white">
                        <div class="flex items-start justify-between">
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    <h1 class="text-2xl font-bold text-slate-900"><?php echo e($lopData['name']); ?></h1>
                                    <?php if($lopData['symbol']): ?>
                            ...
                            <div class="text-right">
                                <div class="text-3xl font-bold text-primary-600"><?php echo e($statistics['total']); ?></div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div class="flex items-center gap-4 p-4 bg-gradient-to-br from-primary-50 to-primary-50 rounded-xl border border-primary-200">
                                ...
                                <div class="min-w-0">
                                    ...
                                    <p class="text-xs text-slate-600 font-medium mt-0.5">
                                        <?php echo e(\Carbon\Carbon::parse($lopData['start_date_one'])->format('d/m/Y')); ?> - <?php echo e(\Carbon\Carbon::parse($lopData['end_date_one'])->format('d/m/Y')); ?>
                            ...
                            <div class="flex items-center gap-4 p-4 bg-gradient-to-br from-primary-50 to-pink-50 rounded-xl border border-primary-200">
                                ...
                                <div class="min-w-0">
                                    ...
                                    <p class="text-xs text-slate-600 font-medium mt-0.5">
                                        <?php echo e(\Carbon\Carbon::parse($lopData['start_date_two'])->format('d/m/Y')); ?> - <?php echo e(\Carbon\Carbon::parse($lopData['end_date_two'])->format('d/m/Y')); ?>
            ...
            <div class="space-y-5">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
                    ...
                    <div class="p-4 space-y-2">
                        ...
                        <a href="<?php echo e($lopData['slug']); ?>/dile=<?php echo e($lopData['id']); ?>"
                            class="flex items-center gap-3 w-full px-4 py-2.5 bg-slate-50 hover:bg-slate-100 text-slate-900 rounded-xl transition-all font-medium">
                            <svg class="w-5 h-5 text-slate-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
                    ...
                    <div class="p-4">
                        ...
                        <div class="space-y-2">
                            ...
                            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.teacher.badge','data' => ['name' => $teacher['name'],'isChuNhiem' => $teacher['is_chu_nhiem'],'size' => '8']]); ?>
<?php $component->withName('teacher.badge'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['name' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($teacher['name']),'isChuNhiem' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($teacher['is_chu_nhiem']),'size' => '8']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
