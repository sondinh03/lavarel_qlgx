      ...
      <table class="table table-hover table-condensed pb-0 mb-0">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><?php echo e(\Carbon\Carbon::createFromTimeStamp($file['last_modified'])->isoFormat(config('backpack.logmanager.date_format') ?: config('backpack.base.default_date_format', 'D MMM YYYY'))); ?></td>
            <td><?php echo e(\Carbon\Carbon::createFromTimeStamp($file['last_modified'])->isoFormat('HH:mm')); ?></td>
            <td class="text-right"><?php echo e(round((int)$file['file_size']/1048576, 2).' MB'); ?></td>
            <td>
                <a class="btn btn-sm btn-link" href="<?php echo e(route('log.show', encrypt($file['file_name']))); ?>"><i class="la la-eye"></i> <?php echo e(trans('backpack::logmanager.preview')); ?></a>
                <a class="btn btn-sm btn-link" href="<?php echo e(route('log.download', encrypt($file['file_name']))); ?>"><i class="la la-cloud-download"></i> <?php echo e(trans('backpack::logmanager.download')); ?></a>
                <?php if(config('backpack.logmanager.allow_delete')): ?>
                    <a class="btn btn-sm btn-link" data-button-type="delete" href="<?php echo e(route('log.destroy', encrypt($file['file_name']))); ?>"><i class="la la-trash-o"></i> <?php echo e(trans('backpack::logmanager.delete')); ?></a>
                <?php endif; ?>
            </td>
          </tr>
...
<?php echo $__env->make(backpack_view('blank'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Document\WORKING\lavarel_qlgx\resources\views/vendor/backpack/logmanager/logs.blade.php ENDPATH**/ ?>