    ...
    <ul class="nav-dropdown-items">
        ...
        if(!empty($user)){
            foreach($user_array as $usex){
                if($usex['id'] == $user->id){
                    ?>
                    <li class='nav-item'><a class='nav-link' href='{{ backpack_url('decen') }}'><i class='nav-icon la la-key'></i> {{ __('backend.decens') }}</a></li>
                    <li class='nav-item'><a class='nav-link' href='{{ backpack_url('set-admin') }}'><i class='nav-icon la la-question'></i> Set admins</a></li>
                    <?php
                }
            }
        }
