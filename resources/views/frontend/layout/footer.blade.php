...
<footer class="text-center bg-white py-3 shadow fs-7">
	<p class="mb-1">{{config('settings.copyright')}}</p>
...
<footer class="bg-white/95 backdrop-blur-sm border-t border-gray-200 py-6 text-center text-sm text-gray-600">
	<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
		<p class="mb-1 font-medium">{{ config('settings.copyright') }}</p>
		<p class="mb-0 text-gray-500">{{ config('settings.address') }}</p>
	</div>
</footer>

{{-- DATEPICKER: Thay thế Bootstrap Datepicker bằng Flatpickr (iOS style) --}}
...
{{-- Cách dùng trong form (ví dụ) --}}
{{-- <input type="text" class="datepicker form-control rounded-xl" placeholder="Chọn ngày"> --}} -->