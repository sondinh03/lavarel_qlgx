...
<head>
    ...
    <style>
        ...
        #sidebar.is-animating { transition: width 200ms ease; }
        #main-wrapper.is-animating { transition: margin-left 200ms ease; }

        /* Hide text labels when mini */
        #sidebar[data-mini="true"] .sidebar-label   { display: none; }
        #sidebar[data-mini="true"] .sidebar-chevron { display: none; }
        #sidebar[data-mini="true"] .logo-text       { display: none; }
        #sidebar[data-mini="true"] .user-info       { display: none; }
