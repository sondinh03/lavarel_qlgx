...
<div class="bg-body-tertiary py-4">
	<div class="container">
		<div class="alert alert-info">
			Thêm danh sách giáo dân bằng excel
		</div>
		@if (session('status'))
        ...
        @endif
		<form class="form-search" action="{{ route('import') }}" method="post" enctype="multipart/form-data">
			@csrf
    		<div class="shadow-sm border bg-white p-3 mb-3">
    			<div class="row">
    				...
    				<div class="group-form col-12 col-md-4 mb-3">
    					<div class="mb-3">
