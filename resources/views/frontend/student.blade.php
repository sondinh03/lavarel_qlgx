...
{{-- SEO --}}
@section('title', Str::title('Điểm danh đi lễ và đi học ' . $student->name))
    					...
    					<div class="border-bottom border-light-subtle pb-2 mb-2">
    						<div class="row">
    							...
    							<div class="col-12 col-md-9">
    								<strong>{{$student->holy}} {{$student->last_name}} {{$student->name}}</strong>
    								<span>(<a title="Sửa" href="{{$student->edit}}" class="text-decoration-none">Sửa</a>)</span>
    							</div>
    						</div>
    					</div>
    				</div>
    				...
    				<div class="col-md-4">
    					<div class="border-bottom border-light-subtle pb-2 mb-2">
    						<div class="row">
    							...
    							<div class="col-12 col-md-9">
    								<strong>{{$student->paid}}{{$student->pid}}{{$student->deid}}{{$student->did}}</strong>
    							</div>
    						</div>
    					</div>
    				</div>
                			    ...
                			    if(!empty($dihoc)){
            			            ...
            			            ?>
                        			    ...
                        			    <form action="" method="post" id="ky1">
                							<input type="hidden" name="lop" value="{{$student->lop}}">
    				...
    				<table class="table table-striped table-bordered table-hover text-nowrap">
                        ...
                        <tbody>
                        	...
                        	<tr>
                            	...
                            	<td>{{$diemthi->kq2}}</td>
                            	<td>{{$diemthi->canam}}</td>
                            	<td>{{$diemthi->seploai}}</td>
                            	<td>{{$diemthi->nghile}}</td>
                            	<td>{{$diemthi->bohoc}}</td>
                            	<td>{{$diemthi->hanhkiem}}</td>
                            	<td>{{$diemthi->ghichu}}</td>
                            </tr>
                            @endif
                    	</tbody>
    				</table>
