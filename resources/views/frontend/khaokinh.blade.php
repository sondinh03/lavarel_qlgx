...
{{-- SEO --}}
@section('title', Str::title('Khảo kinh lớp ' . $lop->name))
...
<div class="container-fluid">
    	...
    	<div class="card border-0">
    		<div class="card-header bg-white">
    			<div class="card-title fw-semibold py-1 fs-5">
    				Khảo kinh học kỳ I - {{$lop->schoolyear}} - {{$lop->name}}
    			</div>
    		</div>
    		<div class="card-body">
            			...
            			<table class="table table-striped table-bordered table-hover text-nowrap">
                          	<thead class="fs-6">
                                <tr>
                                  	...
                                  	@for ($i = 1; $i <= $hk1; $i++)
                                        <th scope="col" class="text-center">Ngày {{ $i }}</th>
                                    @endfor
                                </tr>
                          	</thead>
                          	<tbody class="fs-6">
                                  	...
                                  	<td>
                              			...
                              			<div class="text-center">
                          				    ...
                          				    <div class="form-check form-check-inline">
                              					<input {{$checked_on}} class="form-check-input" type="radio" name="khaokinh[{{$hocsinh->id}}][{{$i}}]" required="" id="khaokinh_{{$i}}_{{$hocsinh->id}}" value="1">
                              					<label class="form-check-label">+</label>
                          					</div>
                          					<div class="form-check form-check-inline">
                          						<input {{$checked_to}} class="form-check-input" type="radio" name="khaokinh[{{$hocsinh->id}}][{{$i}}]" required="" id="khaokinh_{{$i}}_{{$hocsinh->id}}" value="2">
                          						<label class="form-check-label">-</label>
                      						</div>
                  							<div class="form-check form-check-inline">
                              					<input {{$checked_zo}} class="form-check-input" type="radio" name="khaokinh[{{$hocsinh->id}}][{{$i}}]" required="" id="khaokinh_{{$i}}_{{$hocsinh->id}}" value="3">
                          	...
                          	<tfoot>
                                <tr>
                                    <td colspan="3" class="sticky-col second-col">
                                        <input type="button" class="btn btn-info text-white" onclick="add_khaokinh_k1('{{$lop->id}}')" value="Thêm Ngày" />
	...
	<div class="shadow bg-white mb-4 border rounded-4">
    	<div class="card border-0">
    		<div class="card-header bg-white">
    			<div class="card-title fw-semibold py-1 fs-5">
    				Khảo kinh học kỳ II - {{$lop->schoolyear}} - {{$lop->name}}
    			</div>
    		</div>
    		<div class="card-body">
					...
					<div class="table-responsive">
            			...
            			<table class="table table-striped table-bordered table-hover text-nowrap">
                          	...
                          	<tfoot>
                                <tr>
                                    <td colspan="3"  class="sticky-col second-col">
                                        <input type="button" class="btn btn-info text-white" onclick="add_khaokinh_k2('{{$lop->id}}')" value="Thêm Ngày" />
...
<script type="text/javascript">
    var file_items_k1 = '{{$items_k1}}';
    var file_items_k2 = '{{$items_k2}}';
</script>
<script type="text/javascript">
