...
$parishGroup = $teacher->parishGroup->name ?? '';
$phone = trim((string) ($teacher->phone_number ?? ''));
            ...
            ">
                ...
                ">
                    <svg width="28" height="28" viewBox="0 0 24 24" fill="none"
                        stroke="{{ $colors['dark'] }}" stroke-width="1.5"
                        stroke-linecap="round" stroke-linejoin="round"
                        xmlns="http://www.w3.org/2000/svg"
                        style="display: block; width: 28px; height: 28px; max-width: 100%; max-height: 100%;">
