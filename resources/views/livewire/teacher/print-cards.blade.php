...
<div class="min-h-screen bg-apple-gray p-2 sm:p-4 lg:p-6 print:bg-white print:p-0"
    ...
    <div id="print-cards-main" class="print:hidden mx-auto max-w-5xl">
        ...
        @php
        $headerDesc = $teachers->count() > 0
            ? ($teachers->count() . ' thẻ · ' . ceil($teachers->count() / 8) . ' trang A4')
            : 'Chọn giáo lý viên để in thẻ CR80';
        @endphp

        <x-mac-panel :overflow="true">
            <x-page-header
                icon-type="students"
                title="In thẻ giáo lý viên"
            ...
            <div class="p-4 lg:p-6 space-y-6">
                <section>
                    ...
                    <p class="mt-3 text-sm text-slate-500 px-1">
                        Mặc định dùng logo TNTT; tải logo ban giáo lý để thay thế
            ...
            <div class="p-4 lg:p-6">
                <x-stats.page-empty
                    title="Không có giáo lý viên nào để in"
                    description="Chọn giáo lý viên từ danh sách rồi bấm In thẻ">
                    <x-slot name="icon">
