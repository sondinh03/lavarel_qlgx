<div class="container mx-auto px-4 py-8">
    ...
    <div class="mt-8 grid grid-cols-2 md:grid-cols-4 gap-4">
        <a href="{{ route('ds-lop') }}" class="flex flex-col items-center justify-center p-6 bg-white rounded-lg shadow hover:shadow-lg transition border border-gray-200 hover:border-blue-500">
