            ...
            <div class="p-4 lg:p-6 space-y-4">
                <div class="flex flex-col sm:flex-row gap-3 sm:items-center sm:justify-between">
                    ...
                    <input wire:model.debounce.400ms="search" type="search" placeholder="Tìm tên, SĐT, mã..."
                        class="w-full sm:w-64 px-3 py-2 rounded-xl border border-black/[0.06] text-sm shadow-mac-sm bg-white/80" />
                </div>

                <div class="overflow-x-auto">
                    <table class="w-full text-sm">
                        <thead>
                            <tr class="mac-hairline-b text-left text-slate-500">
                ...
                <div class="mac-hairline-t pt-4">{{ $registrations->links() }}</div>
            </div>
        </x-mac-panel>
    </div>
