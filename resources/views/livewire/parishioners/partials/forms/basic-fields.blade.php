...
<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
    ...
    <div>
        ...
        <select wire:model.defer="saint_id" class="{{ $input }}">
            <option value="">-- Chọn --</option>
            @foreach($saints as $id => $name)
    ...
    <div class="md:col-span-2">
        ...
        <img src="{{ asset('storage/' . $currentAvatarPath) }}" class="w-12 h-12 rounded-full mt-2 object-cover" alt="" />
        @endif
