        ...
        <div
            ...
            <div
                ...
                <div class="flex-shrink-0 p-6 border-b border-slate-200 bg-gradient-to-br from-primary-50 to-white">
                    <h2 id="class-modal-title" class="text-xl font-bold text-slate-900">
                        {{ $editingId ? 'Cập nhật lớp học' : 'Thêm lớp học mới' }}
                    </h2>
                    <p class="text-sm text-slate-600 mt-1">Thông tin cơ bản về lớp học</p>
                </div>
                ...
                <div class="flex-1 overflow-y-auto p-6 space-y-5">
                    ...
                    <div>
                        ...
                        <select
                            ...
                            class="w-full px-3 py-2 rounded-xl border border-slate-300
                                   ...
                                   {{ $availableGradeLevels->isEmpty() ? 'bg-slate-100 cursor-not-allowed' : '' }}">
                    ...
                    <x-form-input
                        ...
                        placeholder="VD: 30"
                        help-text="Số học sinh tối đa của lớp. Để trống nếu không giới hạn." />
                    ...
                    <div class="border border-slate-200 rounded-xl p-4">
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1">
                                <label for="class-is-active" class="text-sm font-semibold text-slate-900 cursor-pointer">
                                    Kích hoạt lớp học
                                </label>
                    ...
                    <div class="bg-primary-50 border-l-4 border-primary-500 rounded-xl p-4">
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                <h4 class="text-sm font-semibold text-primary-700">Phân công Giáo lý viên</h4>
