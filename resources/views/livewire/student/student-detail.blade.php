            ...
            <div class="p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="bg-slate-50 rounded-xl p-5 border border-slate-200">
                        ...
                        <div class="space-y-3">
                            ...
                            <x-info-row label="Lớp học" :value="$student['lop_name']" />
                ...
                <div class="max-w-3xl mx-auto">
                    <div class="bg-gradient-to-br from-blue-50 to-white rounded-xl p-6 border border-blue-200">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <x-info-row label="Ngày rửa tội" :value="$student['baptism_date']" icon="calendar" />
                            <x-info-row label="Số sổ" :value="$student['baptism_number']" icon="hash" />
                            <x-info-row label="Cha ban bí tích" :value="$student['baptism_giver']" icon="user" />
                            <x-info-row label="Người đỡ đầu" :value="$student['baptism_sponsor']" icon="user-group" />
                            <div class="md:col-span-2">
                                <x-info-row label="Nơi rửa tội" :value="$student['baptism_full_location']" icon="location" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="max-w-3xl mx-auto">
                    <div class="bg-gradient-to-br from-yellow-50 to-white rounded-xl p-6 border border-yellow-200">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <x-info-row label="Ngày thêm sức" :value="$student['more_power_date']" icon="calendar" />
                            <x-info-row label="Số sổ" :value="$student['more_power_number']" icon="hash" />
                            <x-info-row label="Đức cha ban bí tích" :value="$student['more_power_giver']" icon="user" />
                            <x-info-row label="Người đỡ đầu" :value="$student['more_power_sponsor']" icon="user-group" />
                            <div class="md:col-span-2">
                                <x-info-row label="Nơi thêm sức" :value="$student['more_power_full_location']" icon="location" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="max-w-3xl mx-auto">
                    <div class="bg-gradient-to-br from-green-50 to-white rounded-xl p-6 border border-green-200">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <x-info-row label="Ngày rước lễ" :value="$student['communion_date']" icon="calendar" />
                            <x-info-row label="Số sổ" :value="$student['communion_number']" icon="hash" />
                            <x-info-row label="Cha ban bí tích" :value="$student['communion_giver']" icon="user" />
                            <div class="md:col-span-2">
                                <x-info-row label="Nơi rước lễ" :value="$student['communion_full_location']" icon="location" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="max-w-3xl mx-auto">
                    <div class="bg-gradient-to-br from-red-50 to-white rounded-xl p-6 border border-red-200">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <x-info-row label="Ngày xức dầu" :value="$student['anoint_date']" icon="calendar" />
                            <x-info-row label="Tình trạng" :value="$student['anoint_status']" icon="status" />
                            <x-info-row label="Cha ban bí tích" :value="$student['anoint_giver']" icon="user" />
                            <div class="md:col-span-2">
                                <x-info-row label="Ghi chú" :value="$student['anoint_note']" icon="note" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="bg-slate-50 rounded-xl p-5 border border-slate-200">
                        ...
                        <div class="space-y-3">
                            <x-info-row label="Trình độ học giáo lý" :value="$student['study']" />
                            <x-info-row label="Tân tòng" :value="$student['new_convert']" />
                            <x-info-row label="Đã lập gia đình" :value="$student['married']" />
                            <x-info-row label="Thống kê" :value="$student['statistical']" />
                            <x-info-row label="Ngày hứa" :value="$student['promise_day']" />
                        </div>
                    </div>

                    {{-- Thông tin qua đời (nếu có) --}}
                    @if($student['die_status'] == 1)
                    <div class="bg-slate-50 rounded-xl p-5 border border-slate-200">
                        <h3 class="text-lg font-bold text-slate-900 mb-4 flex items-center gap-2">
                        ...
                        <div class="space-y-3">
                            <x-info-row label="Trạng thái" :value="$student['die_status_label']" />
                            <x-info-row label="Thời gian" :value="$student['die_time']" />
                            <x-info-row label="Số xổ mất" :value="$student['die_lottery']" />
                            <x-info-row label="Nơi qua đời" :value="$student['die_death']" />
                            <x-info-row label="Nơi an táng" :value="$student['die_burial']" />
                        </div>
                    </div>
                    @else
                    {{-- Ghi chú --}}
