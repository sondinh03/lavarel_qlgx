                    ...
                    <div class="p-6 border-b border-slate-200 bg-gradient-to-br from-purple-50 to-white">
                        <div class="flex items-start justify-between">
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    <h1 class="text-2xl font-bold text-slate-900">{{ $lopData['name'] }}</h1>
                                    @if($lopData['symbol'])
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div class="flex items-center gap-4 p-4 bg-gradient-to-br from-indigo-50 to-purple-50 rounded-xl border border-indigo-200">
                                ...
                                <div class="min-w-0">
                                    ...
                                    <p class="text-xs text-slate-600 font-medium mt-0.5">
                                        {{ \Carbon\Carbon::parse($lopData['start_date_one'])->format('d/m/Y') }} - {{ \Carbon\Carbon::parse($lopData['end_date_one'])->format('d/m/Y') }}
                                    </p>
                                </div>
                            </div>
                            @endif
                            ...
                            <div class="flex items-center gap-4 p-4 bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl border border-purple-200">
                                ...
                                <div class="min-w-0">
                                    ...
                                    <p class="text-xs text-slate-600 font-medium mt-0.5">
                                        {{ \Carbon\Carbon::parse($lopData['start_date_two'])->format('d/m/Y') }} - {{ \Carbon\Carbon::parse($lopData['end_date_two'])->format('d/m/Y') }}
                                    </p>
                                </div>
                            </div>
                            @endif
            ...
            <div class="space-y-5">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
                    ...
                    <div class="p-4 space-y-2">
                        ...
                        <a href="{{ $lopData['slug'] }}/dile={{ $lopData['id'] }}"
                            class="flex items-center gap-3 w-full px-4 py-2.5 bg-slate-50 hover:bg-slate-100 text-slate-900 rounded-xl transition-all font-medium">
                            <svg class="w-5 h-5 text-slate-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
                    ...
                    <div class="p-4">
                        ...
                        <div class="space-y-2">
                            ...
                            <x-teacher.badge :name="$teacher['name']" :isChuNhiem="$teacher['is_chu_nhiem']" size="8" />
                            @endforeach
                        </div>
                        @else
