            ...
            <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div class="relative flex-1">
                    ...
                    <input type="text"
                        ...
                        class="w-full pl-11 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-slate-900 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all">
                </div>

                {{-- Filter Button --}}
                <div class="relative">
                    <button type="button" class="flex items-center gap-2 px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl hover:bg-slate-100 active:scale-[0.98] transition-all whitespace-nowrap">
                        ...
                        <tr>
                            <!-- <th class="px-6 py-4">
                                <input
                                    ...
                                    class="w-4 h-4 rounded border-slate-300 text-blue-500 focus:ring-2 focus:ring-blue-500 cursor-pointer">
                            </th> -->
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <div class="relative inline-block" x-data="{ open: false }">
                                        ...
                                        <div x-show="open" @click.outside="open = false" x-transition class="absolute right-0 top-full mt-2 w-48 bg-white rounded-xl border border-slate-200 shadow-lg z-20 overflow-hidden">
                                            ...
                                            <a href="{{ $hocsinh->thugioithieu ?? '#' }}" class="w-full px-4 py-3 text-left hover:bg-slate-50 transition-colors flex items-center gap-3 border-b border-slate-100 block">
