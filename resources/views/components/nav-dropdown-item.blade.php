...
'circle' => 'M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z',
];

$path = $icons[$icon] ?? $icons['circle'];
$isActive = request()->routeIs($route) || request()->routeIs(rtrim($route, '.index') . '.*');
@endphp
...
<a href="{{ route($route) }}"
    ...
    <svg class="w-4 h-4 flex-shrink-0 {{ $isActive ? 'text-primary-600' : 'text-slate-400' }}"
