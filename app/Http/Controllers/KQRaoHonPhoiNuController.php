...
class KQRaoHonPhoiNuController extends Controller
{
    public function store($slug, $id)
    {
        ...
        $templateProcessor = new TemplateProcessor('word-template/KQRaoHonPhoi_Nu.docx');
        ...
        $templateProcessor -> saveAs('KQRaoHonPhoi_Nu.docx');
        return  response()->download('KQRaoHonPhoi_Nu.docx')->deleteFileAfterSend(true);
    }
