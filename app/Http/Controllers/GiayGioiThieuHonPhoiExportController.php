...
class GiayGioiThieuHonPhoiExportController extends Controller
{
    public function store($slug, $id)
    {
        ...
        $templateProcessor = new TemplateProcessor('word-template/HonPhoi.docx');
        ...
        $templateProcessor -> saveAs('HonPhoi.docx');
        return  response()->download('HonPhoi.docx')->deleteFileAfterSend(true);
    }
