...
use App\Http\Requests\LanguagemanagementRequest;
use Backpack\CRUD\app\Http\Controllers\CrudController;
use Backpack\CRUD\app\Library\CrudPanel\CrudPanelFacade as CRUD;
use Backpack\ReviseOperation\ReviseOperation;

/**
 * Class LanguagemanagementCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class LanguagemanagementCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\Languagemanagement::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/languagemanagement');
        CRUD::setEntityNameStrings(__('backend.languagemanagement'), __('backend.languagemanagements'));
    ...
    {
        CRUD::setValidation(LanguagemanagementRequest::class);
