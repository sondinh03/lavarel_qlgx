...
use App\Http\Requests\CareermanagementRequest;
use Backpack\CRUD\app\Http\Controllers\CrudController;
use Backpack\CRUD\app\Library\CrudPanel\CrudPanelFacade as CRUD;
use Backpack\ReviseOperation\ReviseOperation;

/**
 * Class CareermanagementCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class CareermanagementCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\Careermanagement::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/careermanagement');
        CRUD::setEntityNameStrings(__('backend.careermanagement'), __('backend.careermanagements'));
    ...
    {
        CRUD::setValidation(CareermanagementRequest::class);
