...
class RaoHonPhoiNuController extends Controller
{
    public function store($slug, $id)
    {
        ...
        $templateProcessor = new TemplateProcessor('word-template/RaoHonPhoi_Nu.docx');
        ...
        $templateProcessor -> saveAs('RaoHonPhoi_Nu.docx');
        return  response()->download('RaoHonPhoi_Nu.docx')->deleteFileAfterSend(true);
    }
